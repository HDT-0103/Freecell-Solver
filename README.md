...
[![License](https://img.shields.io/badge/License-Academic-blueviolet.svg)](LICENSE)
...
| 24127226 | Phạm Trần Anh Quân | 🛠️ Member |
| 24127252 | Nguyễn Khánh Toàn | 🛠️ Member |
| 24127337 | Nguyễn Tiến Cường | 🛠️ Member |
...
```
⏱️  Thời gian thực thi        —  Tốc độ tìm lời giải
...
- 🖱️ Click chuột để chọn và di chuyển bài
- 🤖 Chọn thuật toán AI từ menu thả xuống
- ▶️ Nhấn **Solve** để bắt đầu giải tự động
- 👁️ Xem quá trình giải từng bước theo animation
